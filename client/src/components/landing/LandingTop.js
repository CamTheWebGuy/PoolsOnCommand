        ...
        <Row>
          <Col className='landing__top-main-content'>
            ...
            <p className='text-styles-20 color-white'>
              ...
              specifically the digital agency business model, that allows you to
              build a sustainable and profitable long term business that
          ...
          <Col md='4' className='landing__sidebar'>
            ...
            <p className='mgn-ng-top-14 text-styles-14'>(Save $31.40 today)</p>
            <p className='text-styles-14'>
              Download The eBook For <strike>$37</strike> Just $5.60! Delivered
              instantly. Start reading in the next 2 minutes.
            </p>
